...
public partial class TemplateManagerViewModel : EditorViewModelBase
{
    ...
    public ObservableCollection<string> Templates => TemplateFiles;

    public ILocalizationService LocalizationManager { get; }

    public TemplateManagerViewModel(IDialogService dialogService, ILocalizationService localization)
    {
